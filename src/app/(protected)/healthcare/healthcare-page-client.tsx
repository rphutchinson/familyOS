...
import { FamilyMemberData, HealthcareProviderData } from "@/types/database";
...
export function HealthcarePageClient({ familyMembers, providers }: HealthcarePageClientProps) {
  ...
  const handleEditProvider = (provider: HealthcareProviderData) => {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-2">
            <AddProviderForm familyMembers={familyMembers} />
          </div>
        </div>
